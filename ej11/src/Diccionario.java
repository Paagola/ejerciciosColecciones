...
public class Diccionario {
    ...
    public String buscarTradEspañol(String español){
        return this.diccionario.get(español) == null ? "": this.diccionario.get(español);
    }
    ...
    public ArrayList<String> dicEspañol(ArrayList<String> dicEsp){
        for (Map.Entry<String,String> value : diccionario.entrySet()) {
            dicEsp.add(value.getKey());
        }
        return dicEsp;
    }
